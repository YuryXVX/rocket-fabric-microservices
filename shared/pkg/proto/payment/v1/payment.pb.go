...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseB\x1dZ\x1bshared/pkg/proto/payment/v1b\x06proto3"
...
var file_payment_v1_payment_proto_depIdxs = []int32{
	...
	1, // 1: payment.v1.BillingService.PayOrder:input_type -> payment.v1.PayOrderRequest
	2, // 2: payment.v1.BillingService.PayOrder:output_type -> payment.v1.PayOrderResponse

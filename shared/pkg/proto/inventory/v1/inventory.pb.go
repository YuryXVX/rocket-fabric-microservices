...
// Value представляет собой union-тип для хранения различных типов данных в metadata
type Value struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x0estock_quantity\x18\x05 \x01(\x03R\rstockQuantity\x12\x12\n" +
	...
	"dimensions\x12>\n" +
	"\fmanufacturer\x18\t \x01(\v2\x1a.inventory.v1.ManufacturerR\fmanufacturer\x12<\n" +
	"\bmetadata\x18\n" +
	...
	"\aGetPart\x12\x1c.inventory.v1.GetPartRequest\x1a\x1d.inventory.v1.GetPartResponseBMZKgithub.com/YuryXVX/rocket-fabric/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	3, // 0: inventory.v1.GetPartResponse.parts:type_name -> inventory.v1.Part
	...
	8, // 6: inventory.v1.Part.updated_at:type_name -> google.protobuf.Timestamp
	6, // 7: inventory.v1.Part.MetadataEntry.value:type_name -> inventory.v1.Value
	1, // 8: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	2, // 9: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
